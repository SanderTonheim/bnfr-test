          ...
          return (
            ...
            >
              <img
                ...
                alt="item logo"
              />
              <div className={s.text}>{item.SecondarysponsorCardText}</div>
            </Link>
          );
        })}
      </div>
